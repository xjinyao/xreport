package com.xjinyao.report.core.export.excel.low;

import com.xjinyao.report.core.definition.Alignment;
import com.xjinyao.report.core.definition.Border;
...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border) {
		if (border.getStyle().equals(com.xjinyao.report.core.definition.BorderStyle.solid)) {
			return BorderStyle.THIN;
		} else if (border.getStyle().equals(com.xjinyao.report.core.definition.BorderStyle.dashed)) {
			return BorderStyle.DASHED;
		} else if (border.getStyle().equals(com.xjinyao.report.core.definition.BorderStyle.doublesolid)) {
