...
export default class XReportDesigner {
    constructor(containerId, searchFormContainerId, cid, au, projectId) {
        ...
        const reportTable = new ReportTable(tableContainer.get(0), au, projectId, function () {
            this.cid = cid;
            this.au = au;
