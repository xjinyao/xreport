...
export default class EditPropertyConditionDialog {
    ...
    init(body, footer) {
        ...
        button.click(function () {
            let property = _this.propertySelect.val(), op = _this.operatorSelect.val(), value = _this.valueEditor.val(),
                join = _this.joinSelect.val(), type = _this.leftTypeSelect.val(), expr = _this.exprEditor.val();
            if (type === 'property') {
                if (property === '') {
