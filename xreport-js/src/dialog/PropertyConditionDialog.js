...
export default class PropertyConditionDialog {
    ...
    _initProperty(container) {
        ...
        const configBorderButton = $(`<button type="button" class="btn btn-default" style="padding: 1px 8px;"><i class="xreport xreport-setting"></i> ${window.i18n.dialog.propCondition.borderConfig}</button>`);
