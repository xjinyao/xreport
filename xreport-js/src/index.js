...
import XReportDesigner from './designer.js';
...
$(document).ready(function () {
    ...
    buildLocal();
    const designer = new XReportDesigner("container", undefined, cid, authorization, projectId);
    let prevTop = 0;
    $(window).scroll(function () {
        ...
        const printLine = $('.xreport-right-hr-for-print');
