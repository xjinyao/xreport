...
export default function buildMenuConfigure() {
    return {
        ...
        items: {
            "insert_row_above": {
                name: `<i class="xreport xreport-insertrow" style="color: #3344d3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertRowUp}`
            },
            "insert_row_below": {
                name: `<i class="xreport xreport-insertrow" style="color: #3344d3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertRowDown}`
            },
            "insert_col_left": {
                name: `<i class="xreport xreport-insert-column" style="color: #008ed3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertColBefore}`
            },
            "insert_col_right": {
                name: `<i class="xreport xreport-insert-column" style="color: #008ed3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertColAfter}`
            },
            "del_row": {
                name: `<i class="xreport xreport-deleterow" style="color: #d30a16;font-size: 13px"></i>  ${window.i18n.table.contextMenu.delRow}`,
                disabled: checkRowDeleteOperationDisabled
            },
            "del_col": {
                name: `<i class="xreport xreport-deletecolumn" style="color: #d30a16;font-size: 13px"></i>  ${window.i18n.table.contextMenu.delCol}`,
                disabled: checkColDeleteOperationDisabled
            },
            "row_height": {
                name: `<i class="xreport xreport-height" style="color: #d30a16;font-size: 13px;font-weight:bold"></i>  ${window.i18n.table.contextMenu.rowHeight}`,
                disabled: checkRowDeleteOperationDisabled
            },
            "col_width": {
                name: `<i class="xreport xreport-width" style="color: #d30a16;font-size: 13px;font-weight:bold"></i>  ${window.i18n.table.contextMenu.colWidth}`,
                disabled: checkColDeleteOperationDisabled
            },
            "title_row": {
                name: `<i class="xreport xreport-title" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.title}`,
                disabled: checkRowDeleteOperationDisabled
            },
            "repeat_row_header": {
                name: `<i class="xreport xreport-header-repeat" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.repeatHeader}`,
                disabled: checkRowDeleteOperationDisabled
            },
            "repeat_row_footer": {
                name: `<i class="xreport xreport-footer-repeat" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.repeatFooter}`,
                disabled: checkRowDeleteOperationDisabled
            },
            "summary_row": {
                name: `<i class="xreport xreport-summary" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.summary}`,
                disabled: checkRowDeleteOperationDisabled
            },
            "repeat_cancel": {
            ...
            "copy_style": {
                name: `<i class="xreport xreport-copy" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.copy}`,
                disabled: checkCopyOperationDisabled
            },
            "paste_style": {
                name: `<i class="xreport xreport-paste" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.paste}`,
                disabled: checkPasteOperationDisabled
            },
            "clean_content": {
                name: `<i class="xreport xreport-clean-content" style="color: #007471;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearContent}`,
                disabled: checkCleanOperationDisabled
            },
            "clean_style": {
                name: `<i class="xreport xreport-clean-style" style="color: #00746f;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearStyle}`,
                disabled: checkCleanOperationDisabled
            },
            "clean": {
                name: `<i class="xreport xreport-clean" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearAll}`,
                disabled: checkCleanOperationDisabled
            }
        }
    };
