...
export default class ReportTable {
    constructor(container, au, projectId, callback) {
        ...
        if (!file || file === null || file === '') {
            file = 'classpath:template/template.xreport.xml';
        } else {
            window._reportFile = file;
        }
        this.cellsMap = new Map();
        this.loadFile(file, au, projectId, callback);
    ...
    loadFile(file, au, projectId, callback) {
        const _this = this;
        ...
        $.ajax({
            ...
            success: function (reportDef) {
                ...
                _this.hot.render();
                if (file !== 'classpath:template/template.xreport.xml') {
