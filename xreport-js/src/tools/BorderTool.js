...
export default class BorderTool extends Tool {
    ...
    buildButton() {
        ...
        const mainBtn = $(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;background: #f8f8f8;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.border.borderLine}">
            <i class="xreport xreport-no-border" style="color: #0e90d2;"></i>
            <span class="caret"></span>
        </button>`);
        const ul = $(`<ul class="dropdown-menu" role="menu"></ul>`);
        const fullBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-full-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.allLine}
                </a>
            </li>`);
        ...
        const noBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-no-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.noBorder}
                </a>
            </li>`);
        ...
        const leftBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-left-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.leftBorder}
                </a>
            </li>`);
        ...
        const rightBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-right-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.rightBorder}
                </a>
            </li>`);
        ...
        const topBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-top-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.topBorder}
                </a>
            </li>`);
        ...
        const bottomBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-bottom-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.bottomBorder}
                </a>
            </li>`);
        ...
        const customBorder = $(`<li>
                <a href="###">
                    <i class="xreport xreport-full-border" style="color: #0e90d2;"></i> ${window.i18n.tools.border.customBorder}
                </a>
            </li>`);
        let content = null;
...
function showCustomBorderDialog(context, content, topBorderStyle, bottomBorderStyle, leftBorderStyle, rightBorderStyle) {
    if (!content) {
        ...
        const allLi = $(`<li class='active'><a data-toggle='tab' href='#allBorderConfig'>${window.i18n.tools.border.all}</a></li>`);
        ul.append(allLi);

        const topLi = $(`<li><a data-toggle='tab' href='#topBorderConfig'>${window.i18n.tools.border.up}</a></li>`);
        ul.append(topLi);
        ...
        const allBorderConfig = $(`<div class="tab-pane fade in active" id="allBorderConfig"></div>`);
        tabContent.append(allBorderConfig);
        buildBorderStyleContent(allBorderConfig, [topBorderStyle, bottomBorderStyle, leftBorderStyle, rightBorderStyle]);
        content.append(tabContent);

        const topBorderConfig = $(`<div class="tab-pane fade" id="topBorderConfig"></div>`);
    ...
    content.parents('.modal-content').css({width: '300px'});
    return content;
}
...
function buildBorderStyleContent(borderConfig, borderStyles) {
    let borderStyle = borderStyles;
    if (Array.isArray(borderStyles)) {
        borderStyle = borderStyles[0];
    }
    let setBorderStyle = function (key, value) {
        if (Array.isArray(borderStyles)) {
            borderStyles.forEach(bs => bs[key] = value);
        } else {
    ...
    const borderColor = $(`<div style="margin: 20px 0 10px 0;"><span>${window.i18n.tools.border.color}：</span></div>`);
    borderConfig.append(borderColor);
    const borderColorContainer = $(`<div style="display: inline-flex;width: 148px;flex-direction: column;"> <input type="text" class="form-control"/> </div>`);
    borderColor.append(borderColorContainer);
    borderColorContainer.colorpicker({
    ...
    borderColorContainer.colorpicker().on("changeColor", function (e) {
